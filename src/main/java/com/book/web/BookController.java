 ...
 * @Author: VaporYan
 * @Decription:
 * @Date: Created in 10:44 2018/5/13
 * @Modified By:
 */
@Controller
public class BookController {
    ...
    public String readerQueryBook(HttpServletRequest request, String searchWord, RedirectAttributes redirectAttributes) {
        boolean exist = bookService.matchBook(searchWord);
        if (exist) {
            ArrayList<Book> books = bookService.queryBook(searchWord);
    ...
    public String deleteBook(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        int res = bookService.deleteBook((int) bookId);
        if (res==1){
