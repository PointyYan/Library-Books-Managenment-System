...
public class BookDao {
    ...
    public int matchBook(String searhWord) {
        String swcx = "%" + searhWord + "%";
    ...
    public int addBook(Book book){
        ...
        return jdbcTemplate.update(ADD_BOOK_SQL,
                new Object[]{name,author,publish,isbn,introduction,language,price,pubdate,classId,pressmark,state});
    }
